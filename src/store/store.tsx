...
export const currentRepositoryAtom = atomWithStorage<Repository>("currentRepository", {
  description: "",
  id: "-1",
  isPrivate: true,
  members: [],
...
export const currentMilestoneAtom = atomWithStorage<Milestone>("currentMilestone", {
  id: "",
  title: "",
  dueDate: new Date(),
  description: "",
